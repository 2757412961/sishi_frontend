    ...
    this.state = {
      columns: [
        ...
        },
        {
          ...
          key: 'articleSource',
          align: 'center',
          sorter: (a, b) => a.articleSource.length - b.articleSource.length,
          sortDirections: ['descend', 'ascend'],
        },
        {
          title: '文章内容',
        ...
        },
        {
          ...
          align: 'center',
          // sorter: (a, b) => a.articleEventTime.length - b.articleEventTime.length,
          sortDirections: ['descend', 'ascend'],
        },
        {
          title: '事件地点',
          ...
          key: 'articleAddress',
          align: 'center',
          // sorter: (a, b) => a.articleAddress.length - b.articleAddress.length,
          sortDirections: ['descend', 'ascend'],
        },
        {
          title: '发布时间',
